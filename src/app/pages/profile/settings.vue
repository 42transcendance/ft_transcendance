	...
	<Card title="Settings">
		<div class="flex flex-col gap-8 w-full">
			...
			<section class="flex flex-col items-center gap-2">
				...
				<button type="button" @click="fileInput?.click()" class="bg-blue-600 rounded-md p-2 hover:bg-blue-700 hover:cursor-pointer">Change Avatar</button>
				<button v-if="fileInput?.files?.length" type="button" @click="uploadAvatar" class="bg-blue-600 rounded-md p-2 hover:bg-blue-700 hover:cursor-pointer">Save Avatar</button>
			...
			<section class="flex flex-col items-center gap-2">
				...
				<button type="button" @click="showUsernamePopup = true" class="bg-blue-600 rounded-md p-2 hover:bg-blue-700 hover:cursor-pointer">Change Username</button>
			...
			<section class="flex flex-col items-center gap-2">
				...
				<button type="button" @click="showPasswordPopup = true" class="bg-blue-600 rounded-md p-2 hover:bg-blue-700 hover:cursor-pointer">Change Password</button>
			...
			<section class="flex flex-col items-center gap-2">
				...
				<button type="button" @click="showDeletePopup = true" class="bg-blue-600 rounded-md p-2 hover:bg-blue-700 hover:cursor-pointer">Delete Account</button>
			</section>
		</div>
	</Card>
		...
		<div class="bg-blue-50 p-8 rounded-md flex flex-col gap-4 w-80">
			...
			<form @submit.prevent="submitUsername" class="flex flex-col gap-4">
				...
				<div class="flex justify-between gap-3">
					<button type="button" @click="showUsernamePopup = false" class="bg-blue-600 rounded-md mt-4 p-2 hover:bg-blue-900 hover:cursor-pointer">Cancel</button>
	...
	<div v-if="showPasswordPopup" class="fixed inset-0 bg-black/30 flex items-center justify-center z-[3000]" @click.self="showPasswordPopup = false">
		<div class="bg-blue-50 p-8 rounded-md flex flex-col gap-4 w-80">
			...
			<form @submit.prevent="submitPassword" class="flex flex-col gap-4">
				...
				<div class="flex justify-between gap-3">
					<button type="button" @click="showPasswordPopup = false" class="bg-blue-600 rounded-md mt-4 p-2 hover:bg-blue-900 hover:cursor-pointer">Cancel</button>
					<FormButton label="Confirm" />
				</div>
			</form>
		</div>
