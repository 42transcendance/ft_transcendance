...
<template>
    <RightCard :isOpen="isChatOpen" :z-index="3" @close="closeChat">
        <div class="flex flex-col w-full h-full gap-4">
            <h2 class="text-2xl font-bold text-center">💬 Chat global</h2>

            <div ref="messagesEl" class="flex-1 overflow-y-auto border rounded-lg p-3 bg-gray-50 text-gray-900">
                <div v-for="msg in messages" :key="msg.id" class="py-1 border-b border-gray-200 last:border-0 text-sm">
                    ...
                    <span v-else class="text-gray-400 italic font-bold">
                        {{ msg.username }}:
                    </span>
            ...
            <form @submit.prevent="sendMessage" class="flex flex-col gap-2">
                <input
                    ...
                    class="border rounded-lg px-3 py-2 bg-white text-gray-900 placeholder:text-gray-500 disabled:text-gray-500"
                />
                <button
                    type="submit"
